...
const CATEGORIES: CategoryDef[] = [
  ...
  { name: "Tarpon & Flats", slug: "tarpon-flats", sortOrder: 15, description: "Premier shallow-water game fish pursued on the flats of Florida, the Gulf Coast, and the Caribbean." },
  { name: "Pacific Rockfish", slug: "pacific-rockfish", sortOrder: 16, description: "Diverse bottom-dwelling species found along the Pacific coast from Alaska to Baja." },
  { name: "Pacific Game Fish", slug: "pacific-game-fish", sortOrder: 17, description: "Popular sport fish of the California coast and Pacific Northwest." },
  { name: "Triggerfish & Tilefish", slug: "triggerfish-tilefish", sortOrder: 18, description: "Reef and deep-bottom species with excellent eating quality." },
  { name: "Rays & Skates", slug: "rays-skates", sortOrder: 19, description: "Large bottom-dwelling fish that provide powerful fights on heavy tackle." },
  { name: "Other Species", slug: "other-species", sortOrder: 20, description: "Additional saltwater species commonly targeted by recreational anglers." },
];
...
const SPECIES_DATA: SpeciesDef[] = [
  ...
  { name: "Dog Snapper", slug: "dog-snapper", scientificName: "Lutjanus jocu", category: "snappers", aliases: ["Jocu"], description: "A large reef-dwelling snapper found in the Florida Keys and Caribbean. Dog Snapper are named for their prominent canine teeth and can reach weights of 30 pounds. They are a challenging target that rewards patient, skilled anglers." },
  { name: "Schoolmaster Snapper", slug: "schoolmaster-snapper", scientificName: "Lutjanus apodus", category: "snappers", aliases: ["Schoolmaster"], description: "A common reef snapper found from South Florida through the Caribbean. Schoolmaster Snapper are typically found in small groups around coral heads and are identified by their yellow fins and blue stripe below the eye." },
  { name: "Mahogany Snapper", slug: "mahogany-snapper", scientificName: "Lutjanus mahogoni", category: "snappers", aliases: ["Mahogany"], description: "A smaller reef snapper found in the Florida Keys and Caribbean waters. Mahogany Snapper are often caught while bottom fishing around patch reefs and are known for their distinctive reddish-brown coloring." },
  ...
  { name: "Wenchman Snapper", slug: "wenchman-snapper", scientificName: "Pristipomoides aquilonaris", category: "snappers", aliases: ["Wenchman"], description: "A deepwater snapper found over rocky bottom and ledges in the Gulf of Mexico and western Atlantic. Wenchman are a common catch on deep-drop trips targeting snapper complex species." },
  ...
  { name: "Goliath Grouper", slug: "goliath-grouper", scientificName: "Epinephelus itajara", category: "groupers", aliases: ["Jewfish", "Giant Grouper"], description: "The largest grouper in the Atlantic Ocean, capable of reaching 800 pounds. Goliath Grouper are found near wrecks, bridges, and reef structure in shallow to moderate depths. Catch-and-release fishing for these gentle giants is a bucket-list experience." },
  ...
  { name: "Warsaw Grouper", slug: "warsaw-grouper", scientificName: "Hyporthodus nigritus", category: "groupers", aliases: ["Black Jewfish"], description: "One of the largest grouper species in the Atlantic, capable of exceeding 300 pounds. Warsaw Grouper are found in deep water around ledges and drop-offs. They provide an incredible fight from the deep and are a true trophy catch." },
  ...
  { name: "Speckled Hind", slug: "speckled-hind", scientificName: "Epinephelus drummondhayi", category: "groupers", aliases: ["Kitty Mitchell", "Calico Grouper", "Strawberry Grouper"], description: "A deepwater grouper found at depths of 150 to 600 feet in the South Atlantic. Speckled Hind are covered with small white spots on a reddish-brown body and are considered exceptional eating." },
  { name: "Rock Hind", slug: "rock-hind", scientificName: "Epinephelus adscensionis", category: "groupers", aliases: ["Rock Grouper"], description: "A small to medium grouper found on rocky reefs and hard bottom in the South Atlantic and Caribbean. Rock Hind are identified by their reddish-brown color with large dark blotches and are a common catch on reef fishing trips." },
  { name: "Nassau Grouper", slug: "nassau-grouper", scientificName: "Epinephelus striatus", category: "groupers", aliases: [], description: "A large, distinctive reef grouper historically found throughout the Caribbean and South Florida. Nassau Grouper are identified by their bold striped pattern and ability to change colors. They are currently protected in US federal waters." },
  { name: "Tiger Grouper", slug: "tiger-grouper", scientificName: "Mycteroperca tigris", category: "groupers", aliases: [], description: "A striking reef grouper found in the Caribbean and occasionally South Florida. Tiger Grouper are named for their dark vertical bars resembling tiger stripes. They provide excellent table fare and a strong fight." },
  { name: "Coney Grouper", slug: "coney-grouper", scientificName: "Cephalopholis fulva", category: "groupers", aliases: ["Coney"], description: "A small, colorful grouper found on coral reefs in the Caribbean and South Florida. Coney are known for their ability to rapidly change color from reddish-brown to bright yellow. They are a common catch on reef trips." },
  ...
  { name: "Permit", slug: "permit", scientificName: "Trachinotus falcatus", category: "jacks-pompanos", aliases: ["Great Pompano", "Round Pompano"], description: "One of the most challenging game fish to catch on a fly rod. Permit are found on shallow flats, wrecks, and reefs from Florida through the Caribbean. They are incredibly wary and selective feeders, making them a prized trophy for experienced anglers." },
  ...
  { name: "Lookdown", slug: "lookdown", scientificName: "Selene vomer", category: "jacks-pompanos", aliases: ["Moonfish"], description: "A striking, diamond-shaped fish with a reflective silver body found in coastal waters of the Atlantic. Lookdowns are typically caught near bridges, piers, and inshore structure. They are good table fare and fascinating to observe." },
  ...
  { name: "Sheepshead", slug: "sheepshead", scientificName: "Archosargus probatocephalus", category: "drums-croakers", aliases: ["Convict Fish", "Sheepie"], description: "A distinctive fish identified by its bold black-and-white vertical stripes and human-like teeth. Sheepshead are found near pilings, jetties, bridges, and oyster bars along the Atlantic and Gulf coasts. They are challenging to hook due to their ability to steal bait but are excellent eating." },
  ...
  { name: "Windowpane Flounder", slug: "windowpane-flounder", scientificName: "Scophthalmus aquosus", category: "flatfish", aliases: ["Windowpane", "Sand Dab"], description: "A thin, nearly transparent flatfish found along the Northeast Atlantic coast. Windowpane Flounder are commonly caught while bottom fishing but are typically too small to keep. They are identified by their large mouth and thin body." },
  ...
  { name: "Nurse Shark", slug: "nurse-shark", scientificName: "Ginglymostoma cirratum", category: "sharks", aliases: [], description: "A slow-moving, bottom-dwelling shark found in warm Atlantic and Gulf waters. Nurse Sharks are commonly encountered on shallow reefs and around docks. They are typically docile but incredibly strong when hooked." },
  { name: "Dusky Shark", slug: "dusky-shark", scientificName: "Carcharhinus obscurus", category: "sharks", aliases: ["Dusky"], description: "A large coastal shark found along the Atlantic seaboard. Dusky Sharks are slow-growing and long-lived, making them a protected species in many areas. They provide powerful fights on heavy tackle." },
  ...
  { name: "Bonnethead Shark", slug: "bonnethead-shark", scientificName: "Sphyrna tiburo", category: "sharks", aliases: ["Bonnethead", "Shovelhead Shark", "Bonnetnose Shark"], description: "The smallest member of the hammerhead family, typically under 4 feet long. Bonnethead Sharks are found in bays, estuaries, and shallow coastal waters. They are popular light-tackle targets and are excellent eating when prepared fresh." },
  ...
  { name: "Pompano Dolphinfish", slug: "pompano-dolphinfish", scientificName: "Coryphaena equiselis", category: "dolphinfish", aliases: ["Pompano Dolphin", "Pompano Mahi"], description: "A smaller relative of the common Mahi-Mahi found in offshore waters. Pompano Dolphinfish are often caught alongside their larger cousin near floating debris and weed lines. They rarely exceed 5 pounds but are just as colorful." },
  ...
  { name: "Cunner", slug: "cunner", scientificName: "Tautogolabrus adspersus", category: "porgies-wrasses", aliases: ["Bergall", "Chogset"], description: "A small wrasse found throughout the Northeast Atlantic from Newfoundland to New Jersey. Cunner are commonly caught near docks, pilings, and rocky structure. While small, they are eager biters and provide family-friendly fishing fun." },

  // ==================== TARPON & FLATS ====================
  { name: "Tarpon", slug: "tarpon", scientificName: "Megalops atlanticus", category: "tarpon-flats", aliases: ["Silver King", "Sabalo", "Poon"], description: "The undisputed king of inshore game fish. Tarpon can exceed 200 pounds and are found in warm waters from Florida through the Gulf and Caribbean. They are renowned for their spectacular leaps, incredible stamina, and prehistoric appearance. Landing a large Tarpon is a life-changing experience for any angler." },
  { name: "Snook", slug: "snook", scientificName: "Centropomus undecimalis", category: "tarpon-flats", aliases: ["Common Snook", "Linesider", "Robalo", "Sergeant Fish"], description: "One of the premier inshore game fish in Florida and the Gulf Coast. Snook are powerful, line-burning fighters found around mangroves, docks, bridges, and beaches. They are excellent table fare (where legal to harvest) and are a bucket-list target for many anglers." },
  { name: "Bonefish", slug: "bonefish", scientificName: "Albula vulpes", category: "tarpon-flats", aliases: ["Gray Ghost", "Bones", "Banana Fish"], description: "The ultimate shallow-water game fish and the most sought-after flats species in the world. Bonefish are found on tropical flats in the Florida Keys and Caribbean. They are incredibly wary, blindingly fast, and catching one on a fly rod is considered one of fishing's greatest achievements." },
  { name: "Ladyfish", slug: "ladyfish", scientificName: "Elops saurus", category: "tarpon-flats", aliases: ["Skipjack", "Ten Pounder", "Poor Man's Tarpon"], description: "A small, acrobatic inshore fish found throughout Florida and the Gulf Coast. Ladyfish are fast strikers that leap repeatedly when hooked, earning them the nickname 'poor man's tarpon.' They are excellent sport on ultralight tackle." },
  { name: "Tripletail", slug: "tripletail", scientificName: "Lobotes surinamensis", category: "tarpon-flats", aliases: ["Blackfish", "Buoy Fish", "Floating Flounder"], description: "A unique fish known for floating on its side near buoys, crab traps, and debris. Tripletail are found in warm waters of the Atlantic, Gulf, and Caribbean. Their three rounded fins give them a distinctive silhouette. They are outstanding table fare with firm, white, sweet-flavored flesh." },

  // ==================== PACIFIC ROCKFISH ====================
  { name: "Vermilion Rockfish", slug: "vermilion-rockfish", scientificName: "Sebastes miniatus", category: "pacific-rockfish", aliases: ["Red Snapper", "Red Rock Cod", "Reds"], description: "One of the most popular rockfish species along the Pacific coast, often called 'Red Snapper' in California (not related to the Atlantic species). Vermilion Rockfish are found near rocky reefs and structure from British Columbia to Baja California." },
  { name: "Copper Rockfish", slug: "copper-rockfish", scientificName: "Sebastes caurinus", category: "pacific-rockfish", aliases: ["Copper", "Whitebelly Rockfish"], description: "A medium-sized rockfish found along the Pacific coast from Alaska to Baja California. Copper Rockfish are identified by their copper-brown coloring with patches of pink and white. They are excellent eating and a popular target for nearshore anglers." },
  { name: "Blue Rockfish", slug: "blue-rockfish", scientificName: "Sebastes mystinus", category: "pacific-rockfish", aliases: ["Blue Bass", "Priestfish"], description: "One of the most commonly caught rockfish along the central and northern California coast. Blue Rockfish are found near rocky reefs and kelp beds in relatively shallow water. They are good eating and readily take both bait and artificial lures." },
  { name: "Canary Rockfish", slug: "canary-rockfish", scientificName: "Sebastes pinniger", category: "pacific-rockfish", aliases: ["Orange Rockfish", "Fantail"], description: "A brightly colored rockfish found from Alaska to Baja California. Canary Rockfish are identified by their orange-yellow coloring and are typically found in deeper water over rocky bottom. They are excellent table fare." },
  { name: "Bocaccio", slug: "bocaccio", scientificName: "Sebastes paucispinis", category: "pacific-rockfish", aliases: ["Salmon Grouper", "Rock Salmon"], description: "One of the largest rockfish species on the Pacific coast, capable of reaching 20 pounds. Bocaccio are found over rocky bottom and near structure from British Columbia to Baja California. They have large mouths and are aggressive predators." },
  { name: "Yelloweye Rockfish", slug: "yelloweye-rockfish", scientificName: "Sebastes ruberrimus", category: "pacific-rockfish", aliases: ["Red Snapper", "Rasphead", "Turkey Red"], description: "The largest rockfish species in the Pacific, capable of reaching 40 pounds and living over 100 years. Yelloweye Rockfish are bright orange-red with distinctive yellow eyes. They are found in deep rocky habitat and are highly prized for their excellent flavor." },
  { name: "Black Rockfish", slug: "black-rockfish", scientificName: "Sebastes melanops", category: "pacific-rockfish", aliases: ["Black Bass", "Black Snapper"], description: "One of the most common rockfish in the Pacific Northwest. Black Rockfish are found near rocky reefs and kelp beds and are popular targets for both boat and shore anglers. They are good fighting fish and excellent eating." },
  { name: "Quillback Rockfish", slug: "quillback-rockfish", scientificName: "Sebastes maliger", category: "pacific-rockfish", aliases: ["Quillback", "Orange-Spotted Rockfish"], description: "A distinctive rockfish identified by its high, sharp dorsal spines and mottled brown-orange coloring. Quillback Rockfish are found from Alaska to central California near rocky structure and are excellent table fare." },
  { name: "Olive Rockfish", slug: "olive-rockfish", scientificName: "Sebastes serranoides", category: "pacific-rockfish", aliases: ["Olive Bass", "Johnny Bass"], description: "A common rockfish found along the California coast near kelp beds and rocky reefs. Olive Rockfish are active swimmers often found higher in the water column compared to other rockfish species. They provide good sport on light tackle." },
  { name: "China Rockfish", slug: "china-rockfish", scientificName: "Sebastes nebulosus", category: "pacific-rockfish", aliases: ["Yellowstripe Rockfish"], description: "A striking rockfish identified by a bold yellow stripe running from the dorsal fin to the lateral line. China Rockfish are found in rocky crevices and caves from Alaska to southern California and are considered excellent eating." },
  { name: "Starry Rockfish", slug: "starry-rockfish", scientificName: "Sebastes constellatus", category: "pacific-rockfish", aliases: ["Spotted Corsair"], description: "A colorful deepwater rockfish found along the southern California coast. Starry Rockfish are orange-red with numerous white dots that give them their name. They are prized for their excellent flavor and firm texture." },
  { name: "Gopher Rockfish", slug: "gopher-rockfish", scientificName: "Sebastes carnatus", category: "pacific-rockfish", aliases: ["Gopher Cod"], description: "A small but popular rockfish found in nearshore rocky habitats along the central California coast. Gopher Rockfish are identified by their mottled brown and pink coloring and are commonly caught from kayaks and small boats near the kelp line." },

  // ==================== PACIFIC GAME FISH ====================
  { name: "California Yellowtail", slug: "california-yellowtail", scientificName: "Seriola dorsalis", category: "pacific-game-fish", aliases: ["Yellowtail", "Yellow", "Mossback", "Homeguard"], description: "One of the most popular game fish along the Southern California coast. Yellowtail are powerful, fast-running jacks found near kelp beds, islands, and offshore banks. They provide spectacular fights and are outstanding table fare. Trophy fish exceed 40 pounds." },
  { name: "White Seabass", slug: "white-seabass", scientificName: "Atractoscion nobilis", category: "pacific-game-fish", aliases: ["White Sea Bass", "Weakfish", "King Croaker"], description: "The largest member of the croaker family on the Pacific coast, capable of exceeding 80 pounds. White Seabass are found near kelp beds and rocky structure along the California coast. They are challenging to find and highly prized for both their fight and outstanding table quality." },
  { name: "Lingcod", slug: "lingcod", scientificName: "Ophiodon elongatus", category: "pacific-game-fish", aliases: ["Ling", "Buckethead"], description: "A large, aggressive predator found from Alaska to Baja California. Lingcod are voracious feeders with enormous mouths and sharp teeth. They are found near rocky bottom and structure and can exceed 60 pounds. Their flesh sometimes has a bluish-green tint that turns white when cooked and is excellent eating." },
  { name: "Barracuda", slug: "barracuda", scientificName: "Sphyraena argentea", category: "pacific-game-fish", aliases: ["California Barracuda", "Pacific Barracuda", "Scooter", "Log"], description: "A fast, aggressive predator found along the Southern California coast. Pacific Barracuda are smaller than their Atlantic cousin but provide exciting action on light tackle. They are typically found near kelp beds and surface schooling during warm-water years." },
  { name: "Pacific Bonito", slug: "pacific-bonito", scientificName: "Sarda chiliensis", category: "pacific-game-fish", aliases: ["Bonito", "Boneheads"], description: "A fast-swimming member of the mackerel family found along the Pacific coast. Pacific Bonito are popular sport fish that travel in large schools and are aggressive surface feeders. They are excellent smoked and are premium live bait for larger game fish." },
  { name: "Kelp Bass", slug: "kelp-bass", scientificName: "Paralabrax clathratus", category: "pacific-game-fish", aliases: ["Calico Bass", "Calico", "Bull Bass"], description: "The most popular nearshore game fish in Southern California. Kelp Bass are found around kelp beds, rocky reefs, and structure throughout the Southern California Bight. They are scrappy fighters on light tackle and excellent table fare, with a minimum size limit that makes them a fun challenge." },
  { name: "Spotted Bay Bass", slug: "spotted-bay-bass", scientificName: "Paralabrax maculatofasciatus", category: "pacific-game-fish", aliases: ["Spotty", "Bay Bass"], description: "A popular light-tackle game fish found in bays and estuaries of Southern California and Baja. Spotted Bay Bass are found near eelgrass, docks, and structure. They are willing biters that provide great sport on light tackle." },
  { name: "Barred Sand Bass", slug: "barred-sand-bass", scientificName: "Paralabrax nebulifer", category: "pacific-game-fish", aliases: ["Sand Bass", "Sandies"], description: "A popular nearshore game fish found along the Southern California coast. Barred Sand Bass are typically found near sandy bottom and structure and are known for forming large spawning aggregations in summer. They are good fighting fish and excellent eating." },
  { name: "Cabezon", slug: "cabezon", scientificName: "Scorpaenichthys marmoratus", category: "pacific-game-fish", aliases: ["Cab", "Bullhead", "Marbled Sculpin"], description: "The largest sculpin species in North America, found along the Pacific coast from Alaska to Baja California. Cabezon are bottom dwellers found in rocky intertidal and subtidal zones. Their flesh is excellent eating, but their roe is toxic and must not be consumed." },
  { name: "Opah", slug: "opah", scientificName: "Lampris guttatus", category: "pacific-game-fish", aliases: ["Moonfish", "Sunfish", "Kingfish"], description: "A spectacular, round-bodied fish found in deep offshore waters of the Pacific. Opah are brightly colored with red fins and silver bodies spotted with white. They are one of the only known warm-blooded fish and their rich, fatty flesh is excellent for grilling and sashimi." },
  { name: "Pacific Mackerel", slug: "pacific-mackerel", scientificName: "Scomber japonicus", category: "pacific-game-fish", aliases: ["Chub Mackerel", "Pacific Jack Mackerel", "Blue Mackerel", "Greenback"], description: "A small, abundant pelagic fish found along the Pacific coast. Pacific Mackerel are popular as both sport fish and bait. They are fast swimmers found in large schools near the surface and are commonly caught from piers, jetties, and party boats." },
  { name: "Yellowfin Croaker", slug: "yellowfin-croaker", scientificName: "Umbrina roncador", category: "pacific-game-fish", aliases: ["Yellowfin", "Golden Croaker"], description: "A popular surf fish found along the Southern California coast. Yellowfin Croaker are identified by their yellow fins and are commonly caught from beaches and piers. They are a favorite target for Southern California surf anglers." },
  { name: "Corbina", slug: "corbina", scientificName: "Menticirrhus undulatus", category: "pacific-game-fish", aliases: ["California Corbina", "Corbie", "Bean"], description: "A prized surf fishing target found along the Southern California coast. Corbina are wary feeders found in the wash zone of sandy beaches. They are considered one of the most challenging and rewarding surf fish to catch and are excellent eating." },

  // ==================== TRIGGERFISH & TILEFISH ====================
  { name: "Gray Triggerfish", slug: "gray-triggerfish", scientificName: "Balistes capriscus", category: "triggerfish-tilefish", aliases: ["Triggerfish", "Trigger", "Leatherjacket"], description: "A popular reef fish found throughout the Gulf of Mexico and South Atlantic. Gray Triggerfish are known for their tough skin, strong teeth, and ability to steal bait. They are challenging to hook but are outstanding table fare with firm, sweet, white flesh." },
  { name: "Queen Triggerfish", slug: "queen-triggerfish", scientificName: "Balistes vetula", category: "triggerfish-tilefish", aliases: ["Queen Trigger", "Ol' Wife"], description: "A strikingly colorful triggerfish found on coral reefs in South Florida and the Caribbean. Queen Triggerfish have brilliant blue, green, and yellow markings and are excellent eating, though they are less commonly targeted than Gray Triggerfish." },
  { name: "Ocean Triggerfish", slug: "ocean-triggerfish", scientificName: "Canthidermis sufflamen", category: "triggerfish-tilefish", aliases: ["Ocean Tally", "Turbot"], description: "A pelagic triggerfish found near floating debris and structure in offshore waters. Ocean Triggerfish are larger than most triggerfish species and are commonly caught while trolling or chunking offshore." },
  { name: "Golden Tilefish", slug: "golden-tilefish", scientificName: "Lopholatilus chamaeleonticeps", category: "triggerfish-tilefish", aliases: ["Tilefish", "Great Northern Tilefish", "Golden Tile"], description: "A spectacular deepwater fish found at depths of 600 to 1,200 feet along the continental shelf edge. Golden Tilefish are brilliantly colored with blue, green, gold, and pink markings. They are one of the finest-eating fish in the ocean and are targeted on deep-drop trips." },
  { name: "Blueline Tilefish", slug: "blueline-tilefish", scientificName: "Caulolatilus microps", category: "triggerfish-tilefish", aliases: ["Gray Tilefish", "Blueline Tile"], description: "A deepwater bottom fish found at depths of 200 to 800 feet in the Gulf and South Atlantic. Blueline Tilefish are identified by a distinctive blue-gold line from snout to eye. They are excellent eating with firm, white, sweet-flavored flesh." },

  // ==================== RAYS & SKATES ====================
  { name: "Stingray", slug: "stingray", scientificName: "Dasyatis spp.", category: "rays-skates", aliases: ["Southern Stingray", "Atlantic Stingray", "Roughtail Stingray"], description: "Large, flat-bodied fish found in shallow coastal waters, bays, and estuaries throughout the Atlantic and Gulf coasts. Stingrays are powerful fighters that provide an intense tug-of-war battle. Several species are commonly encountered by anglers." },
  { name: "Cownose Ray", slug: "cownose-ray", scientificName: "Rhinoptera bonasus", category: "rays-skates", aliases: ["Skeete"], description: "A distinctive ray with a squared-off head found in large schools along the Atlantic coast. Cownose Rays migrate in massive groups and can be targeted on sight-fishing trips. They are powerful fighters when hooked on light tackle." },
  { name: "Eagle Ray", slug: "eagle-ray", scientificName: "Aetobatus narinari", category: "rays-skates", aliases: ["Spotted Eagle Ray"], description: "A spectacular ray identified by its dark blue-black coloring with white spots and long, whip-like tail. Spotted Eagle Rays are found in warm coastal waters and are capable of spectacular aerial leaps. They are typically encountered in shallow bays and near reefs." },

  // ==================== OTHER SPECIES ====================
  { name: "Great Barracuda", slug: "great-barracuda", scientificName: "Sphyraena barracuda", category: "other-species", aliases: ["Barracuda", "Cuda"], description: "A fearsome predator found in warm Atlantic, Gulf, and Caribbean waters. Great Barracuda can exceed 60 pounds and are identified by their torpedo-shaped body and razor-sharp teeth. They are explosive strikers that provide exciting battles, especially on light tackle and flies." },
  { name: "Snowy Cod", slug: "snowy-cod", scientificName: "Lepidion ensiferus", category: "other-species", aliases: [], description: "A deepwater bottom fish found along the continental slope at great depths. Snowy Cod are occasionally caught on deep-drop fishing trips targeting other species." },
  { name: "Spadefish", slug: "spadefish", scientificName: "Chaetodipterus faber", category: "other-species", aliases: ["Atlantic Spadefish", "Angelfish", "Moonfish"], description: "A distinctive disc-shaped fish with bold black vertical bars found near wrecks, buoys, and structure along the Atlantic and Gulf coasts. Spadefish are challenging sight-fishing targets and are excellent table fare with sweet, white flesh." },
  { name: "Toadfish", slug: "toadfish", scientificName: "Opsanus tau", category: "other-species", aliases: ["Oyster Toadfish", "Oyster Cracker", "Ugly Toad"], description: "A bottom-dwelling fish found in bays and estuaries of the Atlantic coast. Toadfish are known for their unusual appearance and loud croaking sounds. They are commonly caught while bottom fishing for other species." },
  { name: "Pinfish", slug: "pinfish", scientificName: "Lagodon rhomboides", category: "other-species", aliases: ["Pin", "Sailor's Choice"], description: "A small, abundant fish found in bays and grassy flats throughout the Atlantic and Gulf coasts. Pinfish are one of the most popular live baits for larger game fish and are commonly caught by young anglers on small hooks." },
  { name: "Mullet", slug: "mullet", scientificName: "Mugil cephalus", category: "other-species", aliases: ["Striped Mullet", "Black Mullet", "Lisa", "Jumping Mullet"], description: "One of the most important baitfish and food fish along the Atlantic and Gulf coasts. Mullet are typically caught with cast nets but can also be caught on small hooks with dough bait. They are excellent smoked and are a staple of coastal cuisine in Florida." },
  { name: "Seatrout", slug: "seatrout", scientificName: "Cynoscion arenarius", category: "other-species", aliases: ["Sand Seatrout", "White Trout", "Sand Trout"], description: "A common inshore fish found in the Gulf of Mexico. Sand Seatrout are smaller relatives of the Spotted Seatrout and are commonly caught in bays and passes. They are good table fare and popular with pier and shore anglers." },
  { name: "Jewfish Snapper", slug: "jewfish-snapper", scientificName: "Pristipomoides typus", category: "other-species", aliases: ["Sharptooth Jobfish"], description: "A deepwater snapper species found in the tropical western Atlantic. These fish are typically caught on deep-drop trips and are known for their excellent eating quality." },
  { name: "Remora", slug: "remora", scientificName: "Echeneis naucrates", category: "other-species", aliases: ["Sharksucker", "Suckerfish", "Slender Suckerfish"], description: "A unique fish with a modified dorsal fin that acts as a suction cup for attaching to sharks, rays, and boats. Remoras are commonly encountered on offshore fishing trips and are sometimes caught on hook and line." },
  { name: "Banded Rudderfish", slug: "banded-rudderfish", scientificName: "Seriola zonata", category: "other-species", aliases: ["Slender Amberjack", "Rudderfish"], description: "A small jack species found near floating debris and structure in the western Atlantic. Banded Rudderfish are the juvenile form of what becomes the adult rudderfish, often found following boats and larger fish." },
  { name: "Ocean Sunfish", slug: "ocean-sunfish", scientificName: "Mola mola", category: "other-species", aliases: ["Mola Mola", "Headfish"], description: "The heaviest bony fish in the world, Ocean Sunfish are occasionally encountered on offshore trips. They are not typically targeted by anglers but are fascinating to observe. Their enormous, flattened body and truncated tail fin make them unmistakable." },
  { name: "Needlefish", slug: "needlefish", scientificName: "Strongylura marina", category: "other-species", aliases: ["Atlantic Needlefish", "Needlenose"], description: "A long, slender surface fish found in coastal waters, bays, and estuaries. Needlefish are commonly seen skipping across the surface and are occasionally caught on small lures and flies. Several species are found along US coasts." },
  { name: "Northern Puffer", slug: "northern-puffer", scientificName: "Sphoeroides maculatus", category: "other-species", aliases: ["Blowfish", "Puffer", "Chicken of the Sea", "Sugar Toad"], description: "A small, round fish that inflates when threatened, found along the Atlantic coast from Florida to New England. Northern Puffer tails, called 'chicken legs,' are a delicacy in the mid-Atlantic region, with sweet, firm flesh resembling chicken." },
  { name: "Searobin", slug: "searobin", scientificName: "Prionotus spp.", category: "other-species", aliases: ["Sea Robin", "Gurnard"], description: "A bottom-dwelling fish with wing-like pectoral fins found throughout the Atlantic coast. Searobins are commonly caught while bottom fishing and are sometimes considered a nuisance, though their firm white flesh is actually quite good eating." },
  { name: "Scad", slug: "scad", scientificName: "Decapterus spp.", category: "other-species", aliases: ["Cigar Minnow", "Round Scad", "Goggle Eye"], description: "Small, fast schooling fish found in coastal waters of the Atlantic and Gulf. Various scad species are among the most popular live and cut baits for larger game fish. They are commonly found near structure and are easy to catch with Sabiki rigs." },
  { name: "American Shad", slug: "american-shad", scientificName: "Alosa sapidissima", category: "other-species", aliases: ["Shad", "White Shad", "Atlantic Shad"], description: "An anadromous fish that runs from the ocean into coastal rivers to spawn each spring. American Shad are the largest herring species in North America and provide fantastic light-tackle sport during their annual spawning runs. They are also prized for their roe." },
];
